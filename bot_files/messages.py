...
button_inline_notify = 'Дані отримано успішно'
...
contact_help = 'Опишіть своє питання чи побажання. Якщо у вас не встановлений псевдонім в профілі Telegram, то напишіть як з вами можна зв\'язатися. У разі якщо ви потрапили в це меню випадково, натисніть нижче "Скасувати".'
